...
pub fn tau() -> f64 { std::f64::consts::TAU }
pub fn inf() -> f64 { f64::INFINITY }
...
pub fn degrees(x: f64) -> f64 { x * 180.0 / std::f64::consts::PI }
pub fn radians(x: f64) -> f64 { x * std::f64::consts::PI / 180.0 }
